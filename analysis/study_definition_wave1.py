...
# This data extract is the data extract for the first wave from 23/03/2020-30/05/2020
...
study = StudyDefinition(
    ...
    died_ons_covid_flag_any_date=patients.with_these_codes_on_death_certificate(
        ...
        date_format="YYYY-MM-DD",
        return_expectations={
            "date": {"earliest": "index_date", "latest": "2020-05-30"},
        },
    ),
)
