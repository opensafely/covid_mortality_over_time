...
table1 <-
  tbl_merge(table_columns_list,
            tab_spanner = c(
              paste0("**Wave 1**, N = ", table_columns_list[[1]]$N),
              paste0("**Wave 2**, N = ", table_columns_list[[2]]$N),
              paste0("**Wave 3**, N = ", table_columns_list[[3]]$N)
            ))
...
table1 <- 
  ...
  !(variable == "asthma" &
    ...
    !(variable == "organ_kidney_transplant" &
        label == "No transplant")) %>%
  modify_column_hide(column = c(stat_1_1, stat_1_2, stat_1_3)) %>%
