...
# This data extract is the data extract for the second wave from 07/09/2020-24/04/2021
...
study = StudyDefinition(
    ...
    died_ons_covid_flag_any_date=patients.with_these_codes_on_death_certificate(
        ...
        date_format="YYYY-MM-DD",
        return_expectations={
            "date": {"earliest": "index_date", "latest": "2021-04-24"},
        },
    ),
)
